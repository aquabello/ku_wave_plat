  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        screenStart: { type: 'string', description: '스크린 세이버 시작 (HH:mm)', example: '08:00' },
        screenEnd: { type: 'string', description: '스크린 세이버 종료 (HH:mm)', example: '20:00' },
        playerVer: { type: 'string', description: '플레이어 버전', example: '1.0.0' },
        playerLink: { type: 'string', description: '플레이어 다운로드 링크', example: 'KUDIDPlayer.exe' },
        watcherVer: { type: 'string', description: '와처 버전', example: '1.0.0' },
        watcherLink: { type: 'string', description: '와처 다운로드 링크', example: 'konkuk_did_watcher.exe' },
        ...
        file: { type: 'string', format: 'binary', description: 'DID 기본 이미지 (JPEG/PNG, 최대 5MB, 선택)' },
      },
