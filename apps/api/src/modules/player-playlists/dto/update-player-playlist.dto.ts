...
import { IsInt, IsOptional, IsEnum, IsString, Matches } from 'class-validator';

export class UpdatePlayerPlaylistDto {
  ...
  @ApiProperty({ example: '1,2,3,4,5', description: '요일', required: false })
  @IsOptional()
  @IsString()
