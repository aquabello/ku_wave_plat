...
한국 커머스 플랫폼 관리자 시스템 (Next.js + NestJS)
...
- ✅ **사용자/권한 관리**: RBAC 기반 접근 제어 (admin/manager/viewer)
- ✅ **대시보드/통계**: 실시간 데이터 시각화 및 분석
- ✅ **데이터 관리 (CRUD)**: 상품, 주문, 고객 관리
- ✅ **시스템 설정**: 환경 설정 및 모니터링
...
- **API**: http://localhost:4000
  - Swagger 문서: http://localhost:4000/api/v1/docs
